...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    proyectoITBAuthUserSubject.add(
      ProyectoITBAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ProyectoITBAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ProyectoITBAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ProyectoITBAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    proyectoITBAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ProyectoITBAuthUser? currentUser;
